...
public class TestData {
    ...
    public static void generate() throws RemoteException {
        ...
        event1.addPlatz(ev2platz1);
        event1.addPlatz(ev2platz2);
        event1.addPlatz(ev2platz3);
        event1.addPlatz(ev2platz4);
        event1.addPlatz(ev2platz5);
        event1.addPlatz(ev2platz6);
        event1.addPlatz(ev2platz7);
        ...
        event1.addPlatz(ev3platz1);
        event1.addPlatz(ev3platz2);
        event1.addPlatz(ev3platz3);
        event1.addPlatz(ev3platz4);
        event1.addPlatz(ev3platz5);
        event1.addPlatz(ev3platz6);
        event1.addPlatz(ev3platz7);
        ...
        event1.addPlatz(ev4platz1);
        event1.addPlatz(ev4platz2);
        event1.addPlatz(ev4platz3);
        event1.addPlatz(ev4platz4);
        event1.addPlatz(ev4platz5);
        event1.addPlatz(ev4platz6);
        event1.addPlatz(ev4platz7);
        ...
        event1.addPlatz(ev5platz1);
        event1.addPlatz(ev5platz2);
        event1.addPlatz(ev5platz3);
        event1.addPlatz(ev5platz4);
        event1.addPlatz(ev5platz5);
        event1.addPlatz(ev5platz6);
        event1.addPlatz(ev5platz7);
        ...
        event1.addPlatz(ev6platz1);
        event1.addPlatz(ev6platz2);
        event1.addPlatz(ev6platz3);
        event1.addPlatz(ev6platz4);
        event1.addPlatz(ev6platz5);
        event1.addPlatz(ev6platz6);
        event1.addPlatz(ev6platz7);
